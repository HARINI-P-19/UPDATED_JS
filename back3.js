...
let studyTips = [
    ...
    "Use visual aids like mind maps and diagrams🗺️",
    ...
    "Create acronyms and mnemonics 📃🖇️for complex information"
];
...
function showNotification(message, type = 'info') {
    ...
    notification.className = `alert alert-${type === 'error' ? 'danger' : type === 'success' ? 'success' : type === 'warning' ? 'warning' : 'info'} alert-dismissible fade show mb-2`;
    ...
    notification.innerHTML = `
        ...
        <button type="button" class="btn-close" onclick="removeNotification(this)" aria-label="Close"></button>
    `;
    ...
    setTimeout(() => {
        removeNotification(notification.querySelector('.btn-close'));
    }, 5000);
